...
function main() {
  ...
  readline.question(`${colors.cyan}Deseja continuar? (sim/não): ${colors.reset}`, (answer) => {
    ...
    if (success) {
      ...
      console.log('  • 14 vídeos atualizados');
      console.log('  • Total COM vídeo: 78 exercícios (49.4%)');
      console.log('  • Total SEM vídeo: 80 exercícios (50.6%)');
