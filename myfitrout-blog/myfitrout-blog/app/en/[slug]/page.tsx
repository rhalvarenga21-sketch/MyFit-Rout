    ...
    <div style={{ position: "relative", zIndex: 1 }}>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <a href="/en" style={{
          ...
          gap: 6, marginBottom: 40, padding: "8px 16px",
        ...
        <div style={{
          ...
          <h3 style={{ fontFamily: "Syne, sans-serif", fontSize: 24, fontWeight: 800, color: "var(--text-primary)", marginBottom: 10 }}>
            Want a personalized workout? 💪
          </h3>
          <p style={{ color: "var(--text-secondary)", fontSize: 15, marginBottom: 22 }}>
            MyFitRout creates programs adapted to your level and goals — powered by AI.
          </p>
