...
export const PRESET_WORKOUTS: PresetWorkout[] = [
  ...
  {
    id: "p-home-fullbody",
    title: { [Language.PT]: "Em Casa - Corpo Inteiro", [Language.EN]: "Home - Full Body", [Language.ES]: "En Casa - Cuerpo Completo" },
    primaryCategory: WorkoutCategory.FULL_BODY,
    tags: [BodyAreaTag.FULL_BODY, BodyAreaTag.CORE],
    duration: 45,
    description: { [Language.PT]: "Treino completo usando apenas peso do corpo.", [Language.EN]: "Full body workout using bodyweight only.", [Language.ES]: "Entrenamiento completo con peso corporal." },
    warmupIds: ["core-1"], // Reuse core as warmup for now
    mainBlockIds: ["leg-2", "sh-2", "core-1"], // Simple mix
    accessoryIds: [],
    cooldownIds: ["core-1"],
    difficulty: ExperienceLevel.BEGINNER,
    environment: 'HOME'
